...
Measured 2026-09-11T18:45:01Z: 7 timed rounds × 16 operations, after one untimed warmup round per level.

| Case | In flight | Operations/s | Throughput / serial | Callback median / p95 ms | Full display checks |
|---|---:|---:|---:|---:|---:|
| small_plain | 1 | 4480.0 | 1.00× | 0.000 / 1.000 | 112 |
| small_plain | 2 | 6588.2 | 1.47× | 0.000 / 1.000 | 112 |
| small_plain | 4 | 8000.0 | 1.79× | 0.000 / 1.000 | 112 |
| small_plain | 8 | 9333.3 | 2.08× | 0.000 / 1.000 | 112 |
| newsletter_html | 1 | 27.8 | 1.00× | 34.000 / 52.000 | 112 |
| newsletter_html | 2 | 35.2 | 1.27× | 49.500 / 86.000 | 112 |
| newsletter_html | 4 | 36.8 | 1.32× | 94.500 / 134.000 | 112 |
| newsletter_html | 8 | 37.3 | 1.34× | 136.000 / 223.000 | 112 |
| nested_mime | 1 | 1898.3 | 1.00× | 0.000 / 1.000 | 112 |
| nested_mime | 2 | 4666.7 | 2.46× | 0.000 / 1.000 | 112 |
| nested_mime | 4 | 7466.7 | 3.93× | 0.000 / 1.000 | 112 |
| nested_mime | 8 | 5600.0 | 2.95× | 1.000 / 2.000 | 112 |
| large_attachment | 1 | 484.8 | 1.00× | 2.000 / 3.000 | 112 |
| large_attachment | 2 | 666.7 | 1.37× | 3.000 / 4.000 | 112 |
| large_attachment | 4 | 800.0 | 1.65× | 4.000 / 8.000 | 112 |
| large_attachment | 8 | 756.8 | 1.56× | 9.000 / 14.000 | 112 |
| unicode | 1 | 3500.0 | 1.00× | 0.000 / 1.000 | 112 |
| unicode | 2 | 5333.3 | 1.52× | 0.000 / 1.000 | 112 |
| unicode | 4 | 5600.0 | 1.60× | 1.000 / 1.000 | 112 |
| unicode | 8 | 8000.0 | 2.29× | 1.000 / 1.000 | 112 |

Before/after QML transport change, same frozen Rust executable and full display reference hashes:

| Case | In flight | Before ops/s | After ops/s | Throughput ratio | Before / after p95 ms |
|---|---:|---:|---:|---:|---:|
| small_plain | 1 | 2947.4 | 4480.0 | 1.52× | 1.000 / 1.000 |
| small_plain | 2 | 3862.1 | 6588.2 | 1.71× | 1.000 / 1.000 |
| small_plain | 4 | 7466.7 | 8000.0 | 1.07× | 1.000 / 1.000 |
| small_plain | 8 | 8000.0 | 9333.3 | 1.17× | 1.000 / 1.000 |
| newsletter_html | 1 | 21.7 | 27.8 | 1.28× | 59.000 / 52.000 |
| newsletter_html | 2 | 27.5 | 35.2 | 1.28× | 90.000 / 86.000 |
| newsletter_html | 4 | 27.1 | 36.8 | 1.36× | 163.000 / 134.000 |
| newsletter_html | 8 | 27.3 | 37.3 | 1.36× | 303.000 / 223.000 |
| nested_mime | 1 | 2947.4 | 1898.3 | 0.64× | 1.000 / 1.000 |
| nested_mime | 2 | 4307.7 | 4666.7 | 1.08× | 1.000 / 1.000 |
| nested_mime | 4 | 5894.7 | 7466.7 | 1.27× | 1.000 / 1.000 |
| nested_mime | 8 | 5600.0 | 5600.0 | 1.00× | 2.000 / 2.000 |
| large_attachment | 1 | 457.1 | 484.8 | 1.06× | 3.000 / 3.000 |
| large_attachment | 2 | 643.7 | 666.7 | 1.04× | 4.000 / 4.000 |
| large_attachment | 4 | 674.7 | 800.0 | 1.19× | 8.000 / 8.000 |
| large_attachment | 8 | 736.8 | 756.8 | 1.03× | 13.000 / 14.000 |
| unicode | 1 | 2604.7 | 3500.0 | 1.34× | 1.000 / 1.000 |
| unicode | 2 | 3612.9 | 5333.3 | 1.48× | 1.000 / 1.000 |
| unicode | 4 | 4480.0 | 5600.0 | 1.25× | 1.000 / 1.000 |
| unicode | 8 | 3294.1 | 8000.0 | 2.43× | 3.000 / 1.000 |
...
CPU: 13th Gen Intel(R) Core(TM) i7-13700KF; load before/after: (1.38037109375, 1.87353515625, 1.90234375) / (1.73583984375, 1.90625, 1.912109375). Versions: {'qt': 'Qml Runtime 6.11.2', 'quickshell': 'Quickshell 0.3.1 (revision , distributed by Arch Linux)'}.
