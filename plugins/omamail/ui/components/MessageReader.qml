...
Item {
  ...
  readonly property int remoteImages: !service ? 0
    : Number(root.shownMode === "reader" ? service.selectedReaderRemoteImages
      : service.selectedRemoteImages) || 0
  readonly property bool remoteImagesAllowed: !!service && service.remoteImagesAllowed === true
  ...
  readonly property int contentWidthLimit: Html.readingColumnWidth(root.bodyWidth, root.shownMode === "reader" ? root.readingMeasure : Style.space(800))
  TextMetrics {
    id: readingSample
  ...
  Item {
    ...
    IconButton {
      ...
      iconName: "star"
      filled: !!root.summary && root.summary.starred === true
