import QtQuick
import qs.Commons
import "MailIcons.js" as MailIcons
...
// so the window's verbs look like the desktop's. `MailIcons.js` is the map from
...
Item {
  ...
  readonly property string glyphText: drawsMark ? "" : MailIcons.glyph(name, filled)
