...
var NBSHELL_KEYS = {
  accent: "nb_accent", red: "nb_red", green: "nb_green", yellow: "nb_yellow",
  blue: "nb_blue", magenta: "nb_magenta", cyan: "nb_cyan"
}
...
function parse(raw) {
  ...
  for (var k = 0; k < SLOT_KEYS.length; k++) {
    var key = SLOT_KEYS[k]
    var value = values[key] || values[ANSI_KEYS[key]] || values[NBSHELL_KEYS[key]] || ""
