...
def main():
    ...
    require(not (args.activity_contract or args.notification_contract or args.menu_contract or args.control_contract or args.audio_contract or args.network_contract or args.bluetooth_contract or args.power_contract) or args.pointer_client, 'Native keyboard tests require --pointer-client')
    if args.inside:
        inside(args); return
    ...
    with tempfile.TemporaryDirectory(prefix='nbshell-lifecycle-') as directory:
        ...
        if args.activity_contract or args.notification_contract or args.menu_contract or args.control_contract or args.audio_contract or args.network_contract or args.bluetooth_contract or args.power_contract:
