...
def inside(args):
    ...
    (config / 'config.json').write_text(json.dumps({
        ...
        'rightWidgets': ['control'] if args.network_contract else ['volume'] if args.audio_contract else ['volume', 'control'] if args.control_contract else (['ai'] if args.startup_ai_widget else []), 'collapsedWidgets': ['clock'],
    }))
...
def main():
    ...
    require(not (args.notification_contract or args.menu_contract or args.control_contract or args.audio_contract or args.network_contract) or args.pointer_client, 'Native keyboard tests require --pointer-client')
    if args.inside:
        inside(args); return
    ...
    with tempfile.TemporaryDirectory(prefix='nbshell-lifecycle-') as directory:
        ...
        if args.notification_contract or args.menu_contract or args.control_contract or args.audio_contract or args.network_contract:
