...
test -f "$XDG_DATA_HOME/applications/dev.nerdi.nbshell.Windows.desktop"
test -s "$XDG_DATA_HOME/icons/hicolor/256x256/apps/dev.nerdi.nbshell.Windows.png"
assert_not_grep -q 'pkexec' "$XDG_DATA_HOME/applications/dev.nerdi.nbshell.Windows.desktop"
