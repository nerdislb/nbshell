...
required_catalog_commands = (
    ...
    "nbshell layout scrolling|dwindle|master|toggle",
    "nbshell compositor status [--json]",
    "nbshell compositor capabilities [--json]",
    "nbshell compositor action <name> [value] [--json]",
    "nbshell todo",
    "nbshell notes",
    "nbshell habits",
    "nbshell plugins",
    "nbshell power",
    "nbshell greeter install [--autologin]",
    "nbshell pip status|apply|size|focus|close",
