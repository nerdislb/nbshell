...
grep -Fq 'property real sectionProgress: Config.rightSectionExpanded ? 1 : 0' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'enabled: !win.barMode' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'id: rightGroupSlot' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'function startSectionMotion()' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'ParallelAnimation {' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'XAnimator {' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'OpacityAnimator {' "$ROOT/shell/Bar/Bar.qml"
grep -Fq '? (Config.rightSectionExpanded ? rightSectionRow.implicitWidth : 0)' "$ROOT/shell/Bar/Bar.qml"
grep -Fq ': rightSectionRow.implicitWidth * rightGroup.sectionProgress)' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'clip: !win.barMode' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'function syncWidgetModels()' "$ROOT/shell/Bar/Bar.qml"
grep -Fq 'if (!sameWidgetModel(expandedRightWidgetNames, nextRight))' "$ROOT/shell/Bar/Bar.qml"
assert_not_grep -Fq 'width: visible && Config.rightSectionExpanded ? rightSectionRow.implicitWidth : 0' "$ROOT/shell/Bar/Bar.qml"
