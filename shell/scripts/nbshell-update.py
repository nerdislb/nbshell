#!/usr/bin/env python3
"""Check and install signed-off nbshell GitHub release artifacts."""
...
def status(channel: str, releases: list[dict] | None = None) -> dict:
    ...
    try:
        ...
        result.update(
            ...
            installable=bool(assets.get(archive_name) and assets.get(checksum_name)),
...
def install(channel: str, assume_yes: bool) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="nbshell-update-") as temp_name:
        ...
        print("Downloading release and checksum …")
        ...
        print("Checksum verified. Starting the nbshell installer …")
